  ...
  return (
    <div className="mx-auto max-w-3xl p-4 space-y-4">
      ...
      <div className="text-sm text-gray-600">
        ...
        <div className="mt-1">Allowed equipment names: Barbell, Dumbbells, Pullup Bar or Rig, Wall Ball, Kettlebell, Row Erg, Bike Erg, Ski Erg, Jump Rope, Climbing Rope, Plyo Box, Axle Bar, GHD, Rings, Sandbag, Sled, Other</div>
        <div className="mt-2">Templates: <a className="text-blue-600 underline" href="/templates/workouts.csv" download>workouts.csv</a> · <a className="text-blue-600 underline" href="/templates/stats.csv" download>stats.csv</a></div>
      </div>
    </div>
  )
}
