  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-4 border border-gray-200">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Percentile Heatmap ({completions})</h3>
        {equip && baselineHeatmap ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div>
              <div className="text-xs text-gray-500 mb-1">Filtered ({equip})</div>
              <MetconHeatmap data={heatmapData} visibleTimeDomains={selection} metric="percentile" hideTitle />
            </div>
            <div>
              <div className="text-xs text-gray-500 mb-1">All equipment</div>
              <MetconHeatmap data={baselineHeatmap} visibleTimeDomains={selection} metric="percentile" hideTitle />
            </div>
          </div>
        ) : (
          <MetconHeatmap data={heatmapData} visibleTimeDomains={selection} metric="percentile" hideTitle />
