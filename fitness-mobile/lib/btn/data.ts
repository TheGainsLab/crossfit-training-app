...
export const exerciseDatabase = [
  ...
  'Pull-ups', 'Alternating Dumbbell Snatches', 'Handstand Push-ups', 'Deadlift',
  'Overhead Squat', 'Thrusters', 'Dumbbell Thrusters', 'Burpees', 'Toes to Bar',
  'Power Clean', 'Burpee Box Jump Overs', 'Box Jumps', 'Box Jump Overs',
  'Clean and Jerk', 'Dumbbell Clean and Jerk', 'Ring Muscle Ups',
  'Rope Climbs', 'Legless Rope Climbs', 'GHD Sit-ups', 'Kettlebell Swings', 'Kettlebell Snatch',
...
export const exerciseEquipment: { [key: string]: string[] } = {
  ...
  'Deadlift': ['Barbell', 'Squat Rack'],
  'Overhead Squat': ['Barbell', 'Squat Rack'],
  'Thrusters': ['Barbell'],
