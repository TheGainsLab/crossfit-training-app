...
export default function MealBuilderView({
  ...
  const [showSavedFoodsPicker, setShowSavedFoodsPicker] = useState(false)
  ...
  // Show saved foods picker
  if (showSavedFoodsPicker) {
    return (
      <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
...
// Saved Foods Picker View Component
